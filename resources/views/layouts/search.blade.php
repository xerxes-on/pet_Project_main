        ...
        <div class="search flex w-screen justify-between p-10">
            ...
            <div class="searchbox w-1/3">
                <form action="" method="POST">
                    <input type="text" id="search" class="text-xl pl-5 py-2 rounded-xl mr-10 w-full"
                           placeholder="Search: books, authors, quotes ...">
                </form>
            </div>
        </div>
        <div id="book-grid"
             class="container grid cursor-pointer grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            @foreach($books as $book)
                <div
                    class="w-56 bg-white border rounded-xl border-gray-200 text-center transform transition-transform hover:scale-105">
